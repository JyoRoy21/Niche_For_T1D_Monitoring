...
# Save the plot
ggsave("Volcanoplot_Early.png", width = 10, height = 6, dpi = 600)

# Save the data frame as CSV
write.csv(results_early, file = "DEGAnalysis_Volcano_Early.csv")
...
# Save the plot
ggsave("Volcanoplot_Intermediate.png", width = 10, height = 6, dpi = 600)

# Save the data frame as CSV
write.csv(results_Intermediate, file = "DEGAnalysis_Volcano_Intermediate.csv")
...
# Genes to label
genes_to_label_late <- c("Ighg2c", "Il31ra", "Tafa2")
...
# Save the plot
ggsave("Volcanoplot_Late.png", width = 10, height = 6, dpi = 600)

# Save the data frame as CSV
write.csv(results_Late, file = "DEGAnalysis_Volcano_Late.csv")
...
ggsave("Immune_and Metabolic_pathways_Scaffold.png", plot, width = 24, height = 18, dpi = 600)
```
