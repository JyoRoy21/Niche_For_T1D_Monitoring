...
T1D_Timepoints<-readRDS("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Sequencing/SingleCellRNASeq/ProcessedRDSFile/annotated_T1D_Timepoints_v5.rds")


Idents(T1D_Timepoints)<-T1D_Timepoints$MacSubType
...
saveRDS(cellChat_W6_Progressor, file = "cellChat_W6_Progressor_MacSpecific.rds")
sessionInfo()
...
saveRDS(cellChat_W6_NonProgressor, file = "cellChat_W6_NonProgressor_MacSpecific.rds")
sessionInfo()
...
saveRDS(cellChat_W12_Progressor, file = "cellChat_W12_Progressor_MacSpecific.rds")
sessionInfo()
...
saveRDS(cellChat_W12_NonProgressor, file = "cellChat_W12_NonProgressor_MacSpecific.rds")
sessionInfo()
...
W6_NonProgressor <- readRDS("cellChat_W6_NonProgressor_MacSpecific.rds")
W6_Progressor <- readRDS("cellChat_W6_Progressor_MacSpecific.rds")
...
gg1 <- netAnalysis_signalingChanges_scatter(cellchat_W6_PvsNP, idents.use = "Mac-1")
gg1
gg2 <- netAnalysis_signalingChanges_scatter(cellchat_W6_PvsNP, idents.use = "Mac-2")
gg2
gg3 <- netAnalysis_signalingChanges_scatter(cellchat_W6_PvsNP, idents.use = "Mac-3")
gg3
...
# #Mac-1
# netVisual_bubble(cellchat_W6_PvsNP, sources.use = 17, targets.use = c(1:16,18:19),  comparison = c(1, 2), angle.x = 45)
# #Mac-2
# netVisual_bubble(cellchat_W6_PvsNP, sources.use = 18, targets.use = c(1:17,19),  comparison = c(1, 2), angle.x = 45)
# #Mac-3
# netVisual_bubble(cellchat_W6_PvsNP, sources.use = 19, targets.use = c(1:18),  comparison = c(1, 2), angle.x = 45)

#Mac-1
gg1 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 17, targets.use = c(1:16,18:19),  comparison = c(1, 2), max.dataset = 2, title.name = "Increased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg2 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 17, targets.use = c(1:16,18:19),  comparison = c(1, 2), max.dataset = 1, title.name = "Decreased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg1 + gg2

#Mac-2
gg1 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 18, targets.use = c(1:17,19),  comparison = c(1, 2), max.dataset = 2, title.name = "Increased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg2 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 18, targets.use = c(1:17,19),  comparison = c(1, 2), max.dataset = 1, title.name = "Decreased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg1 + gg2

#Mac-3
gg1 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 19, targets.use = c(1:18),  comparison = c(1, 2), max.dataset = 2, title.name = "Increased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg2 <- netVisual_bubble(cellchat_W6_PvsNP, sources.use = 19, targets.use = c(1:18),  comparison = c(1, 2), max.dataset = 1, title.name = "Decreased signaling in Progressor Vs Non-Progressor", angle.x = 45, remove.isolate = T)
#> Comparing communications on a merged object
gg1 + gg2

saveRDS(cellchat_W6_PvsNP, file = "cellchat_W6_PvsNP_MacSpecific.rds")
cellchat_W6_PvsNP<-readRDS("cellchat_W6_PvsNP_MacSpecific.rds")
...
pathways.show <- c("GRN") 
netVisual_aggregate(W6_NonProgressor, signaling = pathways.show, layout = "circle")
netVisual_aggregate(W6_Progressor, signaling = pathways.show, layout = "circle")

pathways.show <- c("CD39") 
netVisual_aggregate(W6_NonProgressor, signaling = pathways.show, layout = "circle",vertex.label.cex = 2)
netVisual_aggregate(W6_Progressor, signaling = pathways.show, layout = "circle",vertex.label.cex = 2)
