...
## Option 2: Select DE Genes ----

### Only select the first 3 batches
# Merge metadata by columns (i.e., add samples from Batch 2 to Batch 1)
...
# Step 4: Subset rows in case1_f1 that are present in filtered_genes
case1_f1_subset <- case1_f1[rownames(case1_f1) %in% rownames(filtered_genes), ]



write.csv(case1_f1_subset  , "/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Sequencing/Prediction Analysis/PredictionInput_DESEqfiltered.csv", row.names = TRUE)


## Option 3: Select DE Genes based on pvalue ----
...
write.csv(case1_f1_subset  , "/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Sequencing/Prediction Analysis/PredictionInput_ttestfiltered_DeseqBased.csv", row.names = TRUE)


## Option 4: Select Jess's value based on pvalue ----

case1_f1_Jess <- case1_f1[rownames(case1_f1) %in% c("Csn2","Foxi1","Rims1","Csn1s1","BC006965",
                                                      "Dlx3","Padi3","Acsm3","Acsm3","Yy2","Hpgds",
                                                      "Gria3","Pex26","Smad4"), ]




write.csv(case1_f1_Jess , "/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Sequencing/Prediction Analysis/PredictionInput_JessBiomarkers.csv", row.names = TRUE)
