...
setwd("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold")
early_metab_pathway <- as.data.frame(read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Early Timepoint/pathway_results_scaf_early.csv", sep=",", header=T,check.names = FALSE)) # Raw counts file
early_metab_pathway <- na.omit(early_metab_pathway)

intermediate_metab_pathway <- as.data.frame(read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Intermediate Timepoint/pathway_results_scaf_intermediate.csv", sep=",", header=T,check.names = FALSE)) # Raw counts file
intermediate_metab_pathway <- na.omit(intermediate_metab_pathway)

late_metab_pathway <- as.data.frame(read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Late Timepoint/pathway_results_scaf_late.csv", sep=",", header=T,check.names = FALSE)) # Raw counts file
...
pathway_metabolite_list <- read_excel("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Scaffold_SigMetabPathways_Metabolites.xls", sheet = 1)
...
intermediate_metabs <- read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Intermediate Timepoint/Volcano_scaf_intermediate_unfiltered_FDR.csv", 
...
early_metabs <- read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Early Timepoint/Volcano_scaf_early_unfiltered_FDR.csv",
...
late_metabs <- read.table("/Users/jyotirmoyroy/Desktop/Immunometabolism T1D Paper/Data/Metabolomics/Scaffold_Plasma/Results/Scaffold/Late Timepoint/Volcano_scaf_Late_unfiltered_FDR.csv", 
                          sep=",", header=T, check.names = FALSE)
...
ggplot(all_metabs_with_pathways, aes(x = x_pos, y = `log2(FC)`, size = -log10(p.ajusted))) +
  ...
  theme(
    axis.text.x = element_text(size = 20, angle = 90, hjust = 1, family = "Arial"),  # Adjusted hjust for right shift
