...
pwl_c8_sets <- split(CellTypeMSigDB_gene_sets$gene_symbol, CellTypeMSigDB_gene_sets$gs_name)

pwl_msigdbr <- c(pwl_hallmark, pwl_kegg, pwl_c8_sets) # Compile them all
length(pwl_msigdbr)
...
genes_to_label_late <- c("Ighg2c", "Il31ra", "Tafa2","Cd7", "Il13", "Il17b", "Il17re", "Prf1", "Rorc", "Trbc2", "Tnfrsf17", "Trcg1", "Cd163",    # Classic M2 macrophage scavenger receptor
  ...
  "Fgg",#Fibrinogen subunits, coagulation + inflammation.
  ...
  "Gzma",#Cytotoxic T cell/NK effector molecules.
  "Gzmb",#Cytotoxic T cell/NK effector molecules.
  "Serpinb12", #Protease inhibitor with immune/inflammatory roles.
